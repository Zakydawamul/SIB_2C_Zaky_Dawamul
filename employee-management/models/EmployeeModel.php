...
class EmployeeModel {
    ...
    // Method 10: Halaman Statistik Gaji
    ...
    $query = "SELECT 
              ...
              ORDER BY 
                MIN(CASE 
                    WHEN EXTRACT(YEAR FROM AGE(CURRENT_DATE, hire_date)) < 1 THEN 1
                    WHEN EXTRACT(YEAR FROM AGE(CURRENT_DATE, hire_date)) BETWEEN 1 AND 3 THEN 2
                    ELSE 3
                END)";
